...
\textsf{
    ...
    \vspace{8cm}
    \begin{tabular}{lr}
        Tentative deadline: & 28th March 2020\\
        Last updated: & \today
    \end{tabular}\\
}
\vspace{1.5cm}
...
A special weekly group session\footnote{\url{https://www.uio.no/studier/emner/matnat/fys/FYS-MEK1110/v20/timeplan/index.html}} will focus on this project, where you can discuss with fellow students and get help from teaching assistants. Additionally, you are encouraged to use the Piazza/Padlet platforms for asking your own questions and answering the questions of other students.
